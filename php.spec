...
BuildRequires: bzip2-devel, curl-devel >= 7.20, db4-devel, expat-devel
...
BuildRequires: zlib-devel, smtpdaemon, readline-devel, pcre-devel
...
Requires: libc-client2007 >= 2007e-3
...
Group: Development/Languages
Requires: php-common = %{version}-%{release}, php-pdo
Provides: php_database, libpq.so.5()(64bit)
...
Group: Development/Languages
Requires: php-common = %{version}-%{release} libxml2 >= 2.7
Obsoletes: php-domxml, php-dom
Provides: php-dom, php-xsl, php-domxml
BuildRequires: libxslt-devel >= 1.0.18-1, libxml2-devel >= 2.7
...
for mod in pgsql mysql mysqli odbc ldap snmp xmlrpc imap \
    ...
    dbase mcrypt mhash tidy pspell; do
...
%changelog
* Mon Oct 14 2013 David Bishop <david@gnuconsulting.com> 5.2.17-1
- Initial build

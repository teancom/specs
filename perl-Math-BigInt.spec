...
URL: http://search.cpan.org/search?mode=module&query=Math-BigInt
...
%changelog
* Mon Oct 07 2013 David Bishop <david@gnuconsulting.com> 1.997-1
- Initial build

%define modulename Test-ClassAPI
...
URL: http://search.cpan.org/search?mode=module&query=Test-ClassAPI
...
%changelog
* Wed Oct 02 2013 David Bishop <david@gnuconsulting.com> 1.06-1
- Initial build. 

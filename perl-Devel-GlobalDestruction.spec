%define modulename Devel-GlobalDestruction
...
URL: http://search.cpan.org/search?mode=module&query=Devel-GlobalDestruction
...
%changelog
* Sat Sep 14 2013 David Bishop <david@gnuconsulting.com> 0.11-1
- Initial build. 

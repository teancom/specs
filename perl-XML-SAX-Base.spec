%define modulename XML-SAX-Base
...
URL: http://search.cpan.org/search?mode=module&query=XML-SAX-Base
...
%changelog
* Mon Jan 21 2013 David Bishop <david@gnuconsulting.com> 1.08-1
- Initial build. 

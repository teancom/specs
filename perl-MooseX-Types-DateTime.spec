%define modulename MooseX-Types-DateTime
...
URL: http://search.cpan.org/search?mode=module&query=MooseX-Types-DateTime
...
%changelog
* Tue May 07 2013 David Bishop <david@gnuconsulting.com> 0.08-1
- Initial build. 

%define modulename IO-Socket-SSL
...
URL: http://search.cpan.org/search?mode=module&query=IO-Socket-SSL
...
%changelog
* Wed Oct 02 2013 David Bishop <david@gnuconsulting.com> 1.954-1
- Initial build. 

...
URL: http://search.cpan.org/search?mode=module&query=String-Errf
...
%changelog
* Fri Feb 10 2012 David Bishop <david@gnuconsulting.com> 0.006-1
- Initial build. 

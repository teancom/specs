%define modulename Date-Leapyear
...
URL: http://search.cpan.org/search?mode=module&query=Date-Leapyear
...
%changelog
* Fri Mar 02 2012 David Bishop <david@gnuconsulting.com> 1.72-1
- Initial build. 

...
URL: http://search.cpan.org/search?mode=module&query=Config-MVP
...
%changelog
* Fri Feb 10 2012 David Bishop <david@gnuconsulting.com> 2.200001-1
- Initial build. 

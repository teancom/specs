...
#       --debug --no-upgrade-chk --no-sign --no-depchk Archive::Peek
#   For more information on cpan2rpm please visit: http://perl.arix.com/
#

%define pkgname Archive-Peek
%define filelist %{pkgname}-%{version}-filelist
%define NVR %{pkgname}-%{version}-%{release}
%define maketest 0

name:      perl-Archive-Peek
summary:   Archive-Peek - Peek into archives without extracting them
version:   0.35
release:   1
...
buildarch: noarch
prefix:    %(echo %{_prefix})
source:    http://search.cpan.org//CPAN/authors/id/L/LB/LBROCARD/Archive-Peek-0.35.tar.gz

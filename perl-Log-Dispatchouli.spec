%define modulename Log-Dispatchouli
...
URL: http://search.cpan.org/search?mode=module&query=Log-Dispatchouli
...
%changelog
* Fri Feb 10 2012 David Bishop <david@gnuconsulting.com> 2.005-1
- Initial build. 

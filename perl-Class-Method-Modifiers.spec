%define modulename Class-Method-Modifiers
...
URL: http://search.cpan.org/search?mode=module&query=Class-Method-Modifiers
...
%changelog
* Tue Oct 01 2013 David Bishop <david@gnuconsulting.com> 2.07-1
- Initial build. 

%define modulename Test-Warnings
...
URL: http://search.cpan.org/search?mode=module&query=Test-Warnings
...
%changelog
* Wed Oct 02 2013 David Bishop <david@gnuconsulting.com> 0.010-1
- Initial build. 

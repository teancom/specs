%define modulename Email-Address
...
URL: http://search.cpan.org/search?mode=module&query=Email-Address
...
%changelog
* Fri Mar 02 2012 David Bishop <david@gnuconsulting.com> 1.895-1
- Initial build. 

%define modulename Locale-Maketext-Simple
...
URL: http://search.cpan.org/search?mode=module&query=Locale-Maketext-Simple
...
%changelog
* Mon Jan 21 2013 David Bishop <david@gnuconsulting.com> 0.21-1

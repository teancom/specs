...
URL: http://search.cpan.org/search?mode=module&query=Class-C3
BuildRoot: %{_tmppath}/%{name}-root
BuildRequires: perl >= 0:5.00503
BuildRequires: perl-Class-C3-XS
Requires: perl-Class-C3-XS
...
%changelog
* Wed Oct 02 2013 David Bishop <david@gnuconsulting.com> 0.25-1
- Initial build. 

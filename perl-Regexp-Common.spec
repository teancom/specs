...
#       --debug --no-upgrade-chk --no-sign --no-depchk Regexp::Common
#   For more information on cpan2rpm please visit: http://perl.arix.com/
#

%define pkgname Regexp-Common
...
version:   2011041701
release:   1
vendor:    Abigail <regexp-common@abigail.be>
...
buildarch: noarch
prefix:    %(echo %{_prefix})
source:    http://search.cpan.org//CPAN/authors/id/A/AB/ABIGAIL/Regexp-Common-2011041701.tar.gz

%define modulename Math-Round

Name: perl-%{modulename}
Version: 0.06
Release: 1%{?_dist}
Summary:Perl extension for rounding numbers... is what CPAN says, anyways. 
License: distributable
Group: Development/Libraries
URL: http://search.cpan.org/search?mode=module&query=Math-Round

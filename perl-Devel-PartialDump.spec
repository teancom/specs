...
#       --debug --no-upgrade-chk --no-sign Devel::PartialDump
#   For more information on cpan2rpm please visit: http://perl.arix.com/
#

%define pkgname Devel-PartialDump
%define filelist %{pkgname}-%{version}-filelist
%define NVR %{pkgname}-%{version}-%{release}
%define maketest 1

name:      perl-Devel-PartialDump
summary:   Devel-PartialDump - Partial dumping of data structures, optimized for argument
version:   0.15
release:   1
vendor:    Yuval Kogman <Eltnothingmuch@woobling.orgEgt>
...
buildarch: noarch
prefix:    %(echo %{_prefix})
source:    http://search.cpan.org//CPAN/authors/id/F/FL/FLORA/Devel-PartialDump-0.15.tar.gz

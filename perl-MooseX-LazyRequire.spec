%define modulename MooseX-LazyRequire
...
URL: http://search.cpan.org/search?mode=module&query=MooseX-LazyRequire
...
%changelog
* Fri Feb 10 2012 David Bishop <david@gnuconsulting.com> 0.07-1
- Initial build. 

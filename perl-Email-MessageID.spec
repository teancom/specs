%define modulename Email-MessageID
...
URL: http://search.cpan.org/search?mode=module&query=Email-MessageID
...
%changelog
* Fri Mar 02 2012 David Bishop <david@gnuconsulting.com> 1.402-1
- Initial build. 

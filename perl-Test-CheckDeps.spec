%define modulename Test-CheckDeps
...
URL: http://search.cpan.org/search?mode=module&query=Test-CheckDeps
...
%changelog
* Tue Oct 01 2013 David Bishop <david@gnuconsulting.com> 0.008-1
- Initial build. 

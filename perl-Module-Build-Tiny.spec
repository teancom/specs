%define modulename Module-Build-Tiny
...
URL: http://search.cpan.org/search?mode=module&query=Module-Build-Tiny
...
%changelog
* Tue Oct 01 2013 David Bishop <david@gnuconsulting.com> 0.028-1
- Initial build. 

...
#       --debug --no-upgrade-chk --no-sign MooseX::Singleton
#   For more information on cpan2rpm please visit: http://perl.arix.com/
#

%define pkgname MooseX-Singleton
...
version:   0.27
release:   1
vendor:    Shawn M Moore <sartak@gmail.com>
...
buildarch: noarch
prefix:    %(echo %{_prefix})
source:    http://search.cpan.org//CPAN/authors/id/D/DR/DROLSKY/MooseX-Singleton-0.27.tar.gz

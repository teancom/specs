...
#       --debug --no-upgrade-chk --no-sign Gearman
#   For more information on cpan2rpm please visit: http://perl.arix.com/
#

%define pkgname Gearman
%define filelist %{pkgname}-%{version}-filelist
%define NVR %{pkgname}-%{version}-%{release}
%define maketest 1

name:      perl-Gearman
summary:   Gearman - Client and worker libraries for gearman job dispatch dispatch.  Server is in separate package.
version:   1.11
release:   1
...
buildarch: noarch
prefix:    %(echo %{_prefix})
source:    http://search.cpan.org//CPAN/authors/id/D/DO/DORMANDO/Gearman-1.11.tar.gz

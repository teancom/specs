%define modulename File-HomeDir
...
URL: http://search.cpan.org/search?mode=module&query=File-HomeDir
...
%changelog
* Mon Jan 21 2013 David Bishop <david@gnuconsulting.com> 1.00-1
- Initial build. 

...
#       --debug --no-upgrade-chk --no-sign Data::Structure::Util
#   For more information on cpan2rpm please visit: http://perl.arix.com/
#

%define pkgname Data-Structure-Util
...
buildarch: x86_64
prefix:    %(echo %{_prefix})
source:    http://search.cpan.org//CPAN/authors/id/A/AN/ANDYA/Data-Structure-Util-0.15.tar.gz
...
%{__perl} -MFile::Find -le '
    ...
    print "%doc  CHANGES bin inc README";
...
%changelog
* Sun Dec 18 2011 ec2-user@ip-10-86-133-163
- Initial build.
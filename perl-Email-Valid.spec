...
URL: http://search.cpan.org/search?mode=module&query=Email-Valid
...
%changelog
* Tue Jan 24 2012 David Bishop <david@gnuconsulting.com> 0.186-1
- Initial build. 

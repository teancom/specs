%define modulename Perl-Version
...
URL: http://search.cpan.org/search?mode=module&query=Perl-Version
...
%changelog
* Fri Feb 10 2012 David Bishop <david@gnuconsulting.com> 1.011-1
- Initial build. 

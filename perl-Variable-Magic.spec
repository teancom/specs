%define modulename Variable-Magic
...
URL: http://search.cpan.org/search?mode=module&query=Variable-Magic
...
%changelog
* Wed Oct 02 2013 David Bishop <david@gnuconsulting.com> 0.53-1
- Initial build. 

%define modulename Net-SMTP-SSL
...
URL: http://search.cpan.org/search?mode=module&query=Net-SMTP-SSL
...
%changelog
* Mon Oct 28 2013 David Bishop <david@gnuconsulting.com> 1.01-1
- Initial build. 

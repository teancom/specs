...
#       --debug --no-upgrade-chk --no-sign --version=0.03 Data::Dumper::Names
#   For more information on cpan2rpm please visit: http://perl.arix.com/
#

%define pkgname Data-Dumper-Names
...
buildarch: noarch
prefix:    %(echo %{_prefix})
source:    http://search.cpan.org//CPAN/authors/id/O/OV/OVID/Data-Dumper-Names-0.03.tar.gz

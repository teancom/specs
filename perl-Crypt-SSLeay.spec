%define modulename Crypt-SSLeay
...
URL: http://search.cpan.org/search?mode=module&query=Crypt-SSLeay
...
%changelog
* Wed Oct 02 2013 David Bishop <david@gnuconsulting.com> 0.64-1
- Initial build. 

%define modulename Module-Runtime
...
URL: http://search.cpan.org/search?mode=module&query=Module-Runtime
...
%changelog
* Mon Jan 21 2013 David Bishop <david@gnuconsulting.com> 0.013-1

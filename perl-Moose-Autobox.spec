%define modulename Moose-Autobox
...
URL: http://search.cpan.org/search?mode=module&query=Moose-Autobox
...
%changelog
* Fri Feb 10 2012 David Bishop <david@gnuconsulting.com> 0.11-1
- Initial build. 

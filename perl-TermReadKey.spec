%define modulename TermReadKey

Name: perl-%{modulename}
Version: 2.30
Release: 1%{?_dist}
Summary:Read keystrokes and change terminal modes... is what CPAN says, anyways. 
...
%changelog
* Fri Feb 10 2012 David Bishop <david@gnuconsulting.com> 2.30-1
- Initial build. 

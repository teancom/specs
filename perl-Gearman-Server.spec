...
#       --debug --no-upgrade-chk --no-sign Gearman-Server
...
version:   1.11
release:   1
vendor:    Brad Fitzpatrick (brad@danga.com), Brad Whitaker (whitaker@danga.com)
...
buildarch: noarch
prefix:    %(echo %{_prefix})
source:    http://search.cpan.org//CPAN/authors/id/D/DO/DORMANDO/Gearman-Server-1.11.tar.gz

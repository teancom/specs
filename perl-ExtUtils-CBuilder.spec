...
URL: http://search.cpan.org/search?mode=module&query=ExtUtils-CBuilder
BuildRoot: %{_tmppath}/%{name}-root
BuildRequires: perl >= 0:5.00503
BuildRequires: perl-PathTools >= 3.13
...
%changelog
* Mon Jan 21 2013 David Bishop <david@gnuconsulting.com> 0.280205-1

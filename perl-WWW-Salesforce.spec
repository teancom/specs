...
#       --debug --no-upgrade-chk --no-sign WWW::Salesforce
#   For more information on cpan2rpm please visit: http://perl.arix.com/
#

%define pkgname WWW-Salesforce
%define filelist %{pkgname}-%{version}-filelist
%define NVR %{pkgname}-%{version}-%{release}
%define maketest 1

name:      perl-WWW-Salesforce
summary:   WWW-Salesforce - this class provides a simple abstraction layer between SOAP::Lite and Salesforce.com.
version:   0.14
release:   1
vendor:    Chase Whitener <cwhitener@gmail.com>
...
buildarch: noarch
prefix:    %(echo %{_prefix})
source:    http://search.cpan.org//CPAN/authors/id/P/PH/PHRED/WWW-Salesforce-0.14.tar.gz
...
%changelog
* Sat Dec 17 2011 ec2-user@ip-10-86-133-163
- Initial build.
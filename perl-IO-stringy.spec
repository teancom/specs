...
#       --debug --no-upgrade-chk --no-sign IO::stringy
#   For more information on cpan2rpm please visit: http://perl.arix.com/
#

%define pkgname IO-stringy
%define filelist %{pkgname}-%{version}-filelist
%define NVR %{pkgname}-%{version}-%{release}
%define maketest 1

name:      perl-IO-stringy
summary:   IO-stringy - stringy - I/O on in-core objects like strings and arrays
version:   2.110
release:   1
vendor:     <>
...
buildarch: noarch
prefix:    %(echo %{_prefix})
source:    http://search.cpan.org//CPAN/authors/id/D/DS/DSKOLL/IO-stringy-2.110.tar.gz
...
%{__perl} -MFile::Find -le '
    ...
    print "%doc  contrib examples README";

...
#       --debug --no-upgrade-chk --no-sign MooseX::Storage
#   For more information on cpan2rpm please visit: http://perl.arix.com/
#

%define pkgname MooseX-Storage
%define filelist %{pkgname}-%{version}-filelist
%define NVR %{pkgname}-%{version}-%{release}
%define maketest 1

name:      perl-MooseX-Storage
summary:   MooseX-Storage - A serialization framework for Moose classes
version:   0.30
release:   1
vendor:    Chris Prather <chris.prather@iinteractive.com>
...
buildarch: noarch
prefix:    %(echo %{_prefix})
source:    http://search.cpan.org//CPAN/authors/id/B/BO/BOBTFISH/MooseX-Storage-0.30.tar.gz

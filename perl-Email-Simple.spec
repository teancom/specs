%define modulename Email-Simple
...
URL: http://search.cpan.org/search?mode=module&query=Email-Simple
...
%changelog
* Fri Mar 02 2012 David Bishop <david@gnuconsulting.com> 2.101-1
- Initial build. 
